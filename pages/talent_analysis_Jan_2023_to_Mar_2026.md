---
Title: NNAF Talent Analysis (2023-2026)
---

# NNAF: Talent Analysis (January 2023 - March 2026)
...
talent_home as (
  ...
  from (select distinct name, home_country from talent_demand_2023_2025) t
  left join talent_demand_2023_2025 home_demand
    on home_demand.name = t.name and home_demand.country = t.home_country
  left join talent_demand_2023_2025 ww on ww.name = t.name and ww.country = 'WW'
),
ranked as (
  select
    t.name,
  ...
  from talent_demand_2023_2025 t
  where t.country != 'WW'
),
top5 as (
  select
...
***Note:* Demand Data is taken between 1 January 2023 to 8 March 2026.**
...
with max_values as (
  ...
  from demand_vs_travelability_2023_2025
)
select 
  d.name, 
  d.home_country,
...
from demand_vs_travelability_2023_2025 d
...
```sql countries
select distinct country from talent_demand_2023_2025
```
...
from talent_demand_2023_2025 td
